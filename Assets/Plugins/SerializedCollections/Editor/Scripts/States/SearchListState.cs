...
using System.Linq;
using Plugins.SerializedCollections.Editor.Scripts.Search;
using Plugins.SerializedCollections.Editor.Scripts.Search.Matchers;
using UnityEditor;
using UnityEngine;

namespace Plugins.SerializedCollections.Editor.Scripts.States
{
