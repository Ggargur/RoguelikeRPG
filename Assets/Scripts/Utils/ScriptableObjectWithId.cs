...
namespace Utils
{
    ...
    // THX to: https://gist.github.com/dustingraham/9fa7b68b09fadf01661c3d500c9f01d9
    ...
    public class ScriptableObjectWithId : ScriptableObject, ISerializationCallbackReceiver
    {
        ...
        [SerializeField, ShowOnly] private string internalId;

        [SerializeField, ShowOnly] private long createdAtTicks;
